export const ASSET_MANIFEST = {
  images: {
    ...
    hill_far: '/assets/sprites/hill_far.png',
    hill_near: '/assets/sprites/hill_near.png',
    map_node_open: '/assets/sprites/map_node_open.png',
    map_node_done: '/assets/sprites/map_node_done.png',
    map_node_locked: '/assets/sprites/map_node_locked.png',
    map_node_selected: '/assets/sprites/map_node_selected.png',
    map_path_dot: '/assets/sprites/map_path_dot.png',
